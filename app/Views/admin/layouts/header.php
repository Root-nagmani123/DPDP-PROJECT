<head>
 ...
 <link href="<?php echo base_url('backend/assets/vendor/select2.min.css'); ?>" rel="stylesheet">
  <!-- Template Main CSS File -->
  <link href="<?php echo base_url('backend/assets/css/style.css'); ?>" rel="stylesheet">
  <link href="<?php echo base_url('backend/assets/vendor/jquery.dataTables.min.css'); ?>" rel="stylesheet">
  <link href="<?php echo base_url('backend/assets/vendor/buttons.dataTables.min.css'); ?>" rel="stylesheet">
